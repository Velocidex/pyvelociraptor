...
_VQLCOLLECTORARGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='proto.VQLCollectorArgs.timeout', index=6,
...
_VFSFILEBUFFER = _descriptor.Descriptor(
  name='VFSFileBuffer',
  full_name='proto.VFSFileBuffer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='client_id', full_name='proto.VFSFileBuffer.client_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='offset', full_name='proto.VFSFileBuffer.offset', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='length', full_name='proto.VFSFileBuffer.length', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='proto.VFSFileBuffer.data', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='components', full_name='proto.VFSFileBuffer.components', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='org_id', full_name='proto.VFSFileBuffer.org_id', index=5,
...
_PUSHEVENTREQUEST = _descriptor.Descriptor(
  name='PushEventRequest',
  full_name='proto.PushEventRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='artifact', full_name='proto.PushEventRequest.artifact', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='client_id', full_name='proto.PushEventRequest.client_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flow_id', full_name='proto.PushEventRequest.flow_id', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='jsonl', full_name='proto.PushEventRequest.jsonl', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rows', full_name='proto.PushEventRequest.rows', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='org_id', full_name='proto.PushEventRequest.org_id', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='write', full_name='proto.PushEventRequest.write', index=6,
...
DESCRIPTOR.message_types_by_name['VFSFileBuffer'] = _VFSFILEBUFFER
DESCRIPTOR.message_types_by_name['PushEventRequest'] = _PUSHEVENTREQUEST
...
VFSFileBuffer = _reflection.GeneratedProtocolMessageType('VFSFileBuffer', (_message.Message,), dict(
...
PushEventRequest = _reflection.GeneratedProtocolMessageType('PushEventRequest', (_message.Message,), dict(
  DESCRIPTOR = _PUSHEVENTREQUEST,
  __module__ = 'pyvelociraptor.api_pb2'
  # @@protoc_insertion_point(class_scope:proto.PushEventRequest)
  ))
...
_API = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='VFSGetBuffer',
    full_name='proto.API.VFSGetBuffer',
    index=1,
    containing_service=None,
    input_type=_VFSFILEBUFFER,
    output_type=_VFSFILEBUFFER,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='PushEvents',
    full_name='proto.API.PushEvents',
    index=2,
    containing_service=None,
    input_type=_PUSHEVENTREQUEST,
