...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in pyvelociraptor/api_pb2_grpc.py depends on'
...
class APIStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PushEvents = channel.unary_unary(
                ...
                request_serializer=pyvelociraptor_dot_api__pb2.PushEventRequest.SerializeToString,
...
def add_APIServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'PushEvents': grpc.unary_unary_rpc_method_handler(
                    servicer.PushEvents,
                    request_deserializer=pyvelociraptor_dot_api__pb2.PushEventRequest.FromString,
...
class API(object):
    ...
    def PushEvents(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/proto.API/PushEvents',
            pyvelociraptor_dot_api__pb2.PushEventRequest.SerializeToString,
